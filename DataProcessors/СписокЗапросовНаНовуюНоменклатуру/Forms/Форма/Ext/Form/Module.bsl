...
Процедура СоздатьНоменклатуру(Команда)
	...
	Стк = Новый Структура("идЗапроса,ДатаЗакрытияЗапроса,ПричинаОтказа",идЗапроса,ДатаЗакрытияЗапроса,ПричинаОтказа);
	Оповестить("ЗаписьСписокЗапросовНаНовуюНоменклатуру",Стк);
КонецПроцедуры
...
Процедура ПриОткрытии(Отказ)
	...
	Если  ЕстьФото Тогда
		...
		Если СокрЛП(Наименование) = СокрлП(Номенклатура) ТОгда
			Элементы.грпИзмНоменклатуры.Видимость = Ложь;
			Элементы.СоздатьНоменклатуру.Заголовок = "Добавить фото";
		КонецеСЛИ;
...
Процедура грпСтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	Если ТекущаяСтраница=Элементы.стрФото и ЕстьФото Тогда
